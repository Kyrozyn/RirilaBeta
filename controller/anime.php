...
//        ]);
            ...
            $care[4] = new ImageCarouselColumnTemplateBuilder('https://cdn.myanimelist.net/img/sp/icon/apple-touch-icon-256.png', new MessageTemplateActionBuilder('Next', 'nim*' . $name . '*' . $nextpage));
